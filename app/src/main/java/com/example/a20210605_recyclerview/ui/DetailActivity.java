...
public class DetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //★setLifecycleOwner를 사용해주니 정해진 시간안에 사진이 변경됨
        ...
        detailViewModel.lvBottomImgUrl.setValue("https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FHXzwE%2FbtqYAsr6PuA%2FcKVE91X75vPr8k6sFOQJNK%2Fimg.png");

        //자동으로 몇초 뒤에 이미지가 변하도록 만드는 코드(쓰레드 이용)
        //notifyChange() 메소드로는 변경되었다는 것을 알려주지 못함.(상세 설명은 동영상을 참고)
        //아래의 setValue는 MutableLiveData 사용 했을 때 사용함
        Util.setTimeout(() -> {

            detailViewModel.lvBottomImgUrl.setValue("https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FblrzCX%2FbtqZYlFsLnw%2FefIDhyFwarexUn4TnkXcj0%2Fimg.png");
